...
class ChecksumValidTest(unittest.TestCase):
    def test_valid_checksum(self):
        self.assertTrue(
            checksum.isChecksumValid("!AIVDM,1,1,,B,35MsUdPOh8JwI:0HUwquiIFH21>i,0*09")
        )
        self.assertTrue(
            checksum.isChecksumValid("AIVDM,1,1,,B,35MsUdPOh8JwI:0HUwquiIFH21>i,0*09")
        )
    ...
    def test_invalid_checksum(self):
        self.assertFalse(
            checksum.isChecksumValid("!AIVDM,11,1,,B,35MsUdPOh8JwI:0HUwquiIFH21>i,0*09")
        )
        self.assertFalse(
            checksum.isChecksumValid("!AIVDM,1,1,,B,35MsUdPOh8JwI:0HUwquiIFH21>i,0*FF")
        )
    ...
    def test_no_match_allow_tail_data(self):
        ...
        self.assertFalse(
            checksum.isChecksumValid(
                "!AIVDM,1,1,,B,35MsUdPOh8JwI:0HUwquiIFH21>i,0", allowTailData=True
            )
        )
    ...
    def test_missing_checksum_indicator(self):
        ...
        self.assertFalse(
            checksum.isChecksumValid(
                "!AIVDM,1,1,,B,35MsUdPOh8JwI:0HUwquiIFH21>i,0X09", allowTailData=False
            )
        )
