...
class BareQueueTest(unittest.TestCase):
    ...
    def testManySingleLineVdms(self):
        ...
        self.assertEqual(
            [message["line_nums"][0] for message in messages], [1, 2, 3, 4, 5, 6, 7]
        )
    ...
    def testTwoLineMessage(self):
        ...
        expected = {
            ...
            "matches": [
                {
                    "body": (
                        "55NJPwP00001L@K?77@DhhU>0@5HU>222222220O18@374B<08CCm2EPH0kk"
                    ),
                    "chan": "A",
                    "checksum": "6D",
                    "fill_bits": 0,
            ...
            "matches": [
                {
                    ...
                    "sen_num": 1,
                    "body": (
                        "81mg=5@0EP:4R40807P>0<D1>MNt00000f>FNVfnw7>6>FNU=?B5PD5HDPD8"
                    ),
                    "checksum": "26",
                    "chan": "A",
                    "fill_bits": 0,
                ...
                },
                {
                    ...
                    "sen_num": 2,
                    "body": (
                        "1Dd2J09jL08JArJH5P=E<D9@<5P<9>0`bMl42Q0d2Pc2T59CPCE@@?C54PD?"
                    ),
                    "checksum": "60",
                    "chan": "A",
                    "fill_bits": 0,
