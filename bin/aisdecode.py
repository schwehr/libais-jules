...
warnings.warn(
    "This utility is deprecated and will be removed in 1.0", FutureWarning, stacklevel=2
)
...
if "validateChecksum" in args:
    args["validate_checksum"] = args.pop("validateChecksum")
if "allowUnknown" in args:
    args["allow_unknown"] = args.pop("allowUnknown")
if "treatABequal" in args:
    args["treat_ab_equal"] = args.pop("treatABequal")
...
gpsd_mangle = ais.compatibility.gpsd.Mangler(
    copy_tagblock_timestamp=copy_tagblock_timestamp
)
